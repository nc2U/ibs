...
abstract class _$$SimpleUserModelImplCopyWith<$Res>
    implements $SimpleUserModelCopyWith<$Res> {
  factory _$$SimpleUserModelImplCopyWith(_$SimpleUserModelImpl value,
...
class __$$SimpleUserModelImplCopyWithImpl<$Res>
  ...
  __$$SimpleUserModelImplCopyWithImpl(
      _$SimpleUserModelImpl _value, $Res Function(_$SimpleUserModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$SimpleUserModelImpl(
      pk: null == pk
          ? _value.pk
          : pk // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$SimpleUserModelImpl implements _SimpleUserModel {
  ...
  @override
  String toString() {
    return 'SimpleUserModel(pk: $pk, username: $username, name: $name, email: $email, fullName: $fullName)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, pk, username, name, email, fullName);
  ...
  Map<String, dynamic> toJson() {
    return _$$SimpleUserModelImplToJson(
      this,
    );
  }
}
...
abstract class _SimpleUserModel implements SimpleUserModel {
  const factory _SimpleUserModel(
      ...
      final String name,
      final String? email,
      final String? fullName}) = _$SimpleUserModelImpl;
...
abstract class $SimpleProjectModelCopyWith<$Res> {
  factory $SimpleProjectModelCopyWith(
          SimpleProjectModel value, $Res Function(SimpleProjectModel) then) =
      _$SimpleProjectModelCopyWithImpl<$Res, SimpleProjectModel>;
  @useResult
  $Res call(
      {@JsonKey(readValue: _readPk) int pk, String name, String slug});
}
...
abstract class _$$SimpleProjectModelImplCopyWith<$Res>
    implements $SimpleProjectModelCopyWith<$Res> {
  factory _$$SimpleProjectModelImplCopyWith(_$SimpleProjectModelImpl value,
...
class __$$SimpleProjectModelImplCopyWithImpl<$Res>
  ...
  __$$SimpleProjectModelImplCopyWithImpl(_$SimpleProjectModelImpl _value,
  ...
  $Res call({
    ...
    return _then(_$SimpleProjectModelImpl(
      pk: null == pk
          ? _value.pk
          : pk // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$SimpleProjectModelImpl implements _SimpleProjectModel {
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$SimpleProjectModelImplToJson(
      this,
    );
  }
}
...
abstract class _SimpleProjectModel implements SimpleProjectModel {
  const factory _SimpleProjectModel(
      {@JsonKey(readValue: _readPk) required final int pk,
      final String name,
      final String slug}) = _$SimpleProjectModelImpl;
