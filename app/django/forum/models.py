...
class Forum(models.Model):
    ...
    manager_only = models.BooleanField('관리자 전용 게시판', default=False,
                                       help_text='체크 시 해당 포럼의 manager 또는 최고관리자만 글 작성/수정 가능')
...
class PostCategory(models.Model):
    ...
    is_manager_only = models.BooleanField('게시판 관리자 전용', default=False, help_text='체크 시 해당 포럼의 manager 또는 최고관리자만 작성 가능')
