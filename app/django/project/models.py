...
class Project(models.Model):
    ...
    local_address2 = models.CharField('상세주소', max_length=20, blank=True, default='', null=True)
    local_address3 = models.CharField('참고항목', max_length=20, blank=True, default='', null=True)
...
class Site(models.Model):
    ...
    rights_a = models.TextField('갑구 권리 제한사항', blank=True)
    rights_b = models.TextField('을구 권리 제한사항', blank=True)
