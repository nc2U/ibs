...
router.register(r'fcm-device', accounts.FCMDeviceViewSet, basename='fcm-device')
...
router.register(r'promotion-policy', company.PromotionPolicyViewSet)
router.register(r'staff-evaluation', company.StaffEvaluationViewSet)
router.register(r'promotion-candidate', company.PromotionCandidateViewSet)
router.register(r'staff', company.StaffViewSet)
router.register(r'staff-assignment', company.StaffAssignmentViewSet)
router.register(r'personnel-order', company.PersonnelOrderViewSet)
...
router.register(r'project-subscription', work.ProjectSubscriptionViewSet)
router.register(r'project-bookmark', work.ProjectBookmarkViewSet)
...
router.register(r'work-calendar', work.CalendarViewSet, basename='work-calendar')
...
router.register(r'custom-query', work.CustomQueryViewSet)
...
router.register(r'simple-contractor', contract.SimpleContractorViewSet, basename='simple-contractor')
...
router.register(r'sales-person-document', sales.SalesPersonDocumentViewSet, basename='sales-person-document')
