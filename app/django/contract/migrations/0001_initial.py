...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(upload_to=contract.models.get_contract_docs_file_name, verbose_name='파일')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(upload_to=_utils.file_upload.get_contract_file_path, verbose_name='파일경로')),
                ('file_name', models.CharField(blank=True, db_index=True, max_length=255, verbose_name='파일명')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qualification', models.CharField(choices=[('1', '일반분양'), ('2', '미인가조합원'), ('3', '인가조합원')], default='1', max_length=1, verbose_name='등록상태')),
                ('status', models.CharField(choices=[('1', '청약'), ('2', '계약'), ('3', '변경처리중'), ('4', '계약종결')], default='1', max_length=1, verbose_name='계약자 상태')),
                ('change_type', models.CharField(blank=True, choices=[('1', '해지신청'), ('2', '부적격확인'), ('3', '승계신청')], max_length=1, null=True, verbose_name='변경 유형')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release_type', models.CharField(choices=[('1', '해지신청 (계약자)'), ('2', '부적격확인 (계약자)'), ('3', '해지통보 (공급자)')], default='1', max_length=1, verbose_name='해지 유형')),
                ('status', models.CharField(choices=[('1', '접수등록'), ('2', '해지승인대기'), ('3', '변경인가대기'), ('4', '해지확정'), ('9', '신청취소')], default='1', max_length=1, verbose_name='상태')),
                ('refund_amount', models.PositiveIntegerField(blank=True, null=True, verbose_name='환불(예정)금액')),
                ('refund_account_bank', models.CharField(blank=True, max_length=20, null=True, verbose_name='환불계좌(은행)')),
                ('refund_account_number', models.CharField(blank=True, max_length=25, null=True, verbose_name='환불계좌(번호)')),
                ('refund_account_depositor', models.CharField(blank=True, max_length=20, null=True, verbose_name='환불계좌(예금주)')),
                ('refund_completion_date', models.DateField(blank=True, null=True, verbose_name='해지(환불)처리일')),
                ('completion_date', models.DateField(blank=True, null=True, verbose_name='해지 확정 처리일')),
                ('note', models.TextField(blank=True, default='', verbose_name='비고')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='등록일시')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='편집일시')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('1', '신청접수'), ('2', '변경인가대기'), ('3', '승계완료'), ('9', '승계취소')], default='1', verbose_name='상태')),
                ('note', models.TextField(blank=True, default='', verbose_name='비고')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='등록일시')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='편집일시')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='계약 활성 여부')),
                ('is_completed', models.BooleanField(default=False, verbose_name='계약 완료 여부')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='등록일시')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='편집일시')),
