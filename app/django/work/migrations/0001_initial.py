    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module', models.CharField(choices=[('project', '워크스페이스'), ('meeting', '회의'), ('issue', '업무'), ('news', '공지'), ('docs', '문서'), ('forum', '게시판'), ('calendar', '캘린더'), ('contract', '계약 관리'), ('payment', '수납 관리'), ('notice', '고지 관리'), ('ledger', '자금/원장 관리'), ('site', '사업 부지 관리'), ('hr_work', '인사 관리')], db_index=True, max_length=10, verbose_name='모듈')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='meetings', to='work.issueproject', verbose_name='프로젝트')),
        ...
        migrations.AddField(
            model_name='meeting',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='meetings', to='work.meetingcategory', verbose_name='카테고리'),
        ),
        migrations.CreateModel(
            name='MeetingFile',
            fields=[
