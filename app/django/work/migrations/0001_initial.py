    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('work_core', '업무 관리'), ('ibs_global', '개발 사업'), ('shared', '공통 모듈')], default='work_core', max_length=15, verbose_name='구분')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_index=True, max_length=20, verbose_name='이름')),
                ('category', models.CharField(choices=[('work_core', '업무 관리'), ('ibs_global', '개발 사업')], default='work_core', max_length=15, verbose_name='구분')),
