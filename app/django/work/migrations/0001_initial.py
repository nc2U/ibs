    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module', models.CharField(choices=[('project', '프로젝트'), ('meeting', '회의'), ('issue', '업무'), ('news', '공지'), ('docs', '문서'), ('forum', '게시판'), ('calendar', '캘린더'), ('contract', '계약 관리'), ('payment', '수납 관리'), ('notice', '고지 관리'), ('ledger', '자금/원장 관리'), ('site', '사업 부지 관리'), ('hr_work', '인사 관리')], db_index=True, max_length=10, verbose_name='모듈')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slack_notifications_enabled', models.BooleanField(default=False, help_text='이 프로젝트의 데이터 변동을 Slack으로 실시간 알림받습니다.', verbose_name='Slack 알림 활성화')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, default='', max_length=255, verbose_name='설명')),
                ('target_type', models.CharField(choices=[('project', '프로젝트'), ('meeting', '회의록'), ('issue', '업무'), ('calendar', '캘린더')], db_index=True, max_length=20, verbose_name='대상 모듈')),
