    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module', models.CharField(choices=[('project', '프로젝트'), ('meeting', '회의'), ('issue', '업무'), ('news', '공지'), ('docs', '문서'), ('forum', '게시판'), ('calendar', '달력')], db_index=True, max_length=10, verbose_name='모듈')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ('-id',),
                'indexes': [models.Index(fields=['timestamp', 'project'], name='work_activi_timesta_35b78c_idx')],
            },
        ),
        migrations.CreateModel(
