    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expected_duration', models.CharField(blank=True, choices=[('0', '당일처리'), ('1', '1일 이내'), ('3', '3일 이내'), ('5', '5일 이내'), ('10', '10일 이내'), ('30', '30일 이내'), ('90', '3개월 이내'), ('180', '6개월 이내'), ('365', '1년 이내'), ('366', '1년 이상')], default='0', max_length=3, null=True, verbose_name='예상 처리기간')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='작성자')),
                ('source', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outgoing_relations', to='work.issue', verbose_name='선행 업무')),
                ('target', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='incoming_relation', to='work.issue', verbose_name='후속 업무')),
            ],
        ),
        migrations.CreateModel(
            name='IssueStatus',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('1', '준비'), ('2', '종료'), ('3', '확정'), ('4', '취소')], default='1', max_length=1, verbose_name='회의 상태')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, max_length=100, verbose_name='이름')),
                ('description', models.CharField(blank=True, default='', max_length=255, verbose_name='설명')),
                ('is_in_roadmap', models.BooleanField(default=True, verbose_name='추진현황에 표시')),
                ('order', models.PositiveSmallIntegerField(default=1, verbose_name='정렬')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='등록일')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='수정일')),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='작성자')),
