    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sort', models.CharField(choices=[('project', '프로젝트'), ('issue', '업무관리'), ('time', '시간추적'), ('news', '공지'), ('docs', '문서'), ('forum', '게시판'), ('calendar', '달력')], db_index=True, max_length=10, verbose_name='모듈')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort', models.CharField(choices=[('1', '업무'), ('2', '댓글'), ('4', '공지'), ('5', '문서'), ('8', '글'), ('9', '작업시간')], default='1', max_length=1, verbose_name='구분')),
