    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_due_date', models.DateField(blank=True, help_text='특정일자를 납부기한으로 지정할 경우', null=True, verbose_name='납부 약정일')),
                ...
                ('excluded_order_groups', models.ManyToManyField(blank=True, help_text='특정 차수에서 이 회차를 건너뛸 경우(잔금 이월 등) 해당 차수를 선택하세요.', related_name='excluded_payments', to='contract.ordergroup', verbose_name='제외 차수')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('deal_date', models.DateField(blank=True, db_index=True, editable=False, help_text='⚠️ related_transaction.deal_date에서 자동 동기화 (직접 수정 불가)', null=True, verbose_name='거래일자')),
                ...
                ('contract', models.ForeignKey(blank=True, editable=False, help_text='⚠️ accounting_entry.contract에서 자동 동기화 (직접 수정 불가)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='payments', to='contract.contract', verbose_name='계약')),
                ...
                ('project', models.ForeignKey(editable=False, help_text='⚠️ accounting_entry.project에서 자동 동기화 (직접 수정 불가)', on_delete=django.db.models.deletion.CASCADE, to='project.project', verbose_name='프로젝트')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['project', 'deal_date'], name='payment_con_project_5e291f_idx'), models.Index(fields=['contract', 'deal_date'], name='payment_con_contrac_ced2a1_idx'), models.Index(fields=['deal_date', 'installment_order'], name='payment_con_deal_da_bd2217_idx'), models.Index(fields=['installment_order', 'created_at'], name='payment_con_install_e362d2_idx')],
            },
        ),
        migrations.CreateModel(
