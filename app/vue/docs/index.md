...
### ✉️ 3. 대외 공문 관리 (Official Letter)

* **[발송 공문 관리](/approval/official-letter)**: 대외 공문서 표준 A4 작성, 실시간 프리뷰 및 발송 증빙 관리
* **[수신 공문 관리](/document/)**: 외부 수신 공문서 접수 및 부서 배부 관리 (단계적 통합)
...
* **[회사 인장 및 전결 관리](/authority/company-seal)**: 관리부서 인장 등록, 전결 직책 설정 및 오남용 통제
