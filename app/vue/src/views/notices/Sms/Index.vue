              ...
              <v-expansion-panel>
                ...
                <v-expansion-panel-text>
                  <CRow class="align-items-end">
                    ...
                    <CCol :md="4">
                      <v-btn color="primary" @click="addRecipient" prepend-icon="mdi-plus" block>
                        추가
                      </v-btn>
                    </CCol>
                  </CRow>
        ...
        <CRow>
          ...
          <CCol :md="6" :xs="12">
            <div class="mb-3">
              ...
              <v-radio-group v-model="currentForm.scheduledSend" inline>
                <v-radio label="즉시 발송" :value="false" />
                <v-radio label="예약 발송" :value="true" />
              </v-radio-group>
            </div>

            <div v-if="currentForm.scheduledSend" class="mb-3">
              <CRow>
                <CCol :md="6">
                  <CFormInput v-model="currentForm.scheduleDate" type="date" label="발송 날짜" />
                </CCol>
                <CCol :md="6">
                  <CFormInput v-model="currentForm.scheduleTime" type="time" label="발송 시간" />
                </CCol>
              </CRow>
            </div>
          </CCol>
          ...
          <CCol :md="6" :xs="12">
            <div class="text-center">
              <v-btn
                :color="activeTab === 'sms' ? 'primary' : 'success'"
                size="large"
                @click="sendMessage"
                :loading="isSending"
                :disabled="isDisabled"
                :prepend-icon="activeTab === 'sms' ? 'mdi-send' : 'mdi-chat'"
                class="mb-3"
              >
                {{ buttonText }}
              </v-btn>
