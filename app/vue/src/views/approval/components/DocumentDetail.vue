  ...
  <template v-else>
    ...
    <CCard class="mb-3">
      ...
      <CCardBody>
        ...
        <template v-if="document.doc_type_detail?.form_template_key === 'LEAVE_APPLICATION' || document.doc_type_detail?.form_template_key === 'LEAVE'">
          <CTable small bordered responsive class="mb-0">
            <CTableBody>
              <CTableRow>
        ...
        <template v-else-if="document.doc_type_detail?.form_template_key === 'EXPENSE_REPORT' || document.doc_type_detail?.form_template_key === 'EXPENSE'">
        ...
        <template v-else-if="document.doc_type_detail?.form_template_key === 'PURCHASE_ORDER' || document.doc_type_detail?.form_template_key === 'PURCHASE'">
          <CTable small bordered responsive class="mb-3">
            <CTableBody>
              <CTableRow>
        ...
        <template v-else-if="document.doc_type_detail?.form_template_key === 'OFFICIAL_LETTER'">
          <CTable small bordered responsive class="mb-0">
            <CTableBody>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">수신처</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-semibold text-primary">{{ docContent.receiver || '-' }}</CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">참조처</CTableHeaderCell>
              ...
              <CTableRow>
                ...
                <CTableDataCell class="pl-3">{{ docContent.sender_name || '대표이사' }}</CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light">대외 문서번호</CTableHeaderCell>
                <CTableDataCell class="pl-3">{{ docContent.doc_number_external || '-' }}</CTableDataCell>
              </CTableRow>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">공문 제목</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3 fw-bold">{{ docContent.letter_subject || '-' }}</CTableDataCell>
              </CTableRow>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">공문 본문(요지)</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3 py-3" style="white-space: pre-wrap; line-height: 1.6;">{{ docContent.letter_body || '-' }}</CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.enclosed_files_desc">
                <CTableHeaderCell class="text-center bg-more-light">붙임 서류 내역</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3" style="white-space: pre-wrap;">{{ docContent.enclosed_files_desc }}</CTableDataCell>
              </CTableRow>
              <CTableRow>
        ...
        <template v-else-if="document.doc_type_detail?.form_template_key === 'GENERAL' || document.doc_type_detail?.form_template_key === 'BIZ_APPROVAL'">
          <CTable small bordered responsive class="mb-0">
            <CTableBody>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">품의 목적</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3 fw-bold text-primary">{{ docContent.purpose || '-' }}</CTableDataCell>
              </CTableRow>
              <CTableRow>
                ...
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">예산 과목</CTableHeaderCell>
                <CTableDataCell class="pl-3">{{ docContent.budget_account || '일반관리비' }}</CTableDataCell>
              </CTableRow>
              <CTableRow>
                ...
                <CTableDataCell colspan="3" class="pl-3">
                  ...
                  <span v-if="!docContent.budget && !docContent.amount" class="text-muted small ms-2">(예산 비소요)</span>
                </CTableDataCell>
              </CTableRow>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">세부 품의 내용</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3 py-3" style="white-space: pre-wrap; line-height: 1.6;">{{ docContent.content || '-' }}</CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.expected_effect">
                <CTableHeaderCell class="text-center bg-more-light">기대 효과</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3" style="white-space: pre-wrap;">{{ docContent.expected_effect }}</CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.note">
                <CTableHeaderCell class="text-center bg-more-light">비고 / 특이사항</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3 text-muted">{{ docContent.note }}</CTableDataCell>
              </CTableRow>
            </CTableBody>
          </CTable>
        </template>
        ...
        <template v-else-if="document.doc_type_detail?.form_template_key === 'BUSINESS_TRIP' || document.doc_type_detail?.form_template_key === 'TRIP'">
          <CTable small bordered responsive class="mb-3">
            <CTableBody>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">출장 구분</CTableHeaderCell>
                <CTableDataCell class="pl-3">
                  <CBadge color="primary">{{ docContent.trip_type === 'OVERSEAS' ? '해외 출장' : '국내 출장' }}</CBadge>
                </CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">출장지</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-semibold text-primary">{{ docContent.destination || '-' }}</CTableDataCell>
              </CTableRow>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">출장 기간</CTableHeaderCell>
                <CTableDataCell class="pl-3">
                  {{ docContent.start_date || '-' }} ~ {{ docContent.end_date || '-' }}
                  <CBadge color="info" class="ms-2">{{ docContent.nights_count ?? 0 }}박 {{ docContent.days_count ?? 1 }}일</CBadge>
                </CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light">교통편</CTableHeaderCell>
                <CTableDataCell class="pl-3">{{ docContent.transportation || '법인차량' }}</CTableDataCell>
              </CTableRow>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">출장 목적</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3 fw-bold">{{ docContent.purpose || '-' }}</CTableDataCell>
              </CTableRow>
              <CTableRow>
              ...
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">비상 연락처</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3">{{ docContent.emergency_contact || '-' }}</CTableDataCell>
              </CTableRow>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">세부 여비 내역</CTableHeaderCell>
                <CTableDataCell colspan="3" class="p-2">
                  <div class="d-flex gap-4 small">
                    <span>교통비: <strong>{{ (Number(docContent.transport_cost) || 0).toLocaleString() }}</strong> 원</span>
                    <span>숙박비: <strong>{{ (Number(docContent.lodging_cost) || 0).toLocaleString() }}</strong> 원</span>
                    <span>일비/식비: <strong>{{ (Number(docContent.daily_allowance) || 0).toLocaleString() }}</strong> 원</span>
                    <span>기타: <strong>{{ (Number(docContent.other_cost) || 0).toLocaleString() }}</strong> 원</span>
                  </div>
                </CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.itinerary">
                <CTableHeaderCell class="text-center bg-more-light">세부 일정 계획</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3 py-3" style="white-space: pre-wrap; line-height: 1.6;">{{ docContent.itinerary }}</CTableDataCell>
              </CTableRow>
            </CTableBody>
          </CTable>
          <div class="d-flex justify-content-end align-items-center p-2 bg-light border rounded">
            <span class="me-2 fw-semibold">총 예상 출장 여비:</span>
            <span class="fs-5 fw-bold text-danger">{{ (Number(docContent.total_cost ?? docContent.amount) || 0).toLocaleString() }} 원</span>
          </div>
        </template>

        <!-- 7. 연장/휴일근무 신청서 (OVERTIME / OVERTIME_WORK) -->
        <template v-else-if="document.doc_type_detail?.form_template_key === 'OVERTIME' || document.doc_type_detail?.form_template_key === 'OVERTIME_WORK'">
          <CTable small bordered responsive class="mb-0">
            <CTableBody>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">근무 구분</CTableHeaderCell>
                <CTableDataCell class="pl-3">
                  <CBadge :color="docContent.work_type === 'HOLIDAY' ? 'danger' : docContent.work_type === 'NIGHT' ? 'dark' : 'primary'">
                    {{ docContent.work_type === 'HOLIDAY' ? '휴일 근무' : docContent.work_type === 'NIGHT' ? '야간 근무' : '평일 연장근무' }}
                  </CBadge>
                </CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">근무 일자</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-semibold">{{ docContent.work_date || '-' }}</CTableDataCell>
              </CTableRow>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">근무 시간</CTableHeaderCell>
                <CTableDataCell class="pl-3">
                  {{ docContent.start_time || '-' }} ~ {{ docContent.end_time || '-' }}
                  <span v-if="docContent.break_hours" class="text-muted small ms-2">(휴게: {{ docContent.break_hours }}시간)</span>
                </CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light">인정 시간</CTableHeaderCell>
                <CTableDataCell class="pl-3">
                  <span class="fs-6 fw-bold text-primary">{{ docContent.total_hours ?? 0 }} 시간</span>
                </CTableDataCell>
              </CTableRow>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">보상 방식</CTableHeaderCell>
                <CTableDataCell class="pl-3">
                  <CBadge color="info">{{ docContent.compensation_type === 'COMP_LEAVE' ? '대체휴무 (보상휴가) 적립' : '수당 지급' }}</CBadge>
                </CTableDataCell>
              ...
              <CTableRow>
                ...
                <CTableDataCell colspan="3" class="pl-3 py-3" style="white-space: pre-wrap; line-height: 1.6;">{{ docContent.reason || '-' }}</CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.note">
                <CTableHeaderCell class="text-center bg-more-light">비고 / 특이사항</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3 text-muted">{{ docContent.note }}</CTableDataCell>
        ...
        <template v-else-if="document.doc_type_detail?.form_template_key === 'HR_APPOINTMENT' || document.doc_type_detail?.form_template_key === 'APPOINTMENT'">
          <CTable small bordered responsive class="mb-3">
            <CTableBody>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">발령 구분</CTableHeaderCell>
                <CTableDataCell class="pl-3">
                  <CBadge color="primary">{{ docContent.appointment_type || '승진/전보' }}</CBadge>
                </CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">발령 시행일</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-bold text-danger">{{ docContent.effective_date || '-' }}</CTableDataCell>
              </CTableRow>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">발령 사유/배경</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3 py-2" style="white-space: pre-wrap; line-height: 1.6;">{{ docContent.reason || '-' }}</CTableDataCell>
              </CTableRow>
            </CTableBody>
          </CTable>
            ...
            <CTable small bordered responsive hover class="text-center mb-0 align-middle">
              ...
              <CTableBody class="small">
                <CTableRow v-for="(t, idx) in docContent.targets" :key="idx">
                  ...
                  <CTableDataCell class="text-muted">{{ t.current_dept || '-' }} / {{ t.current_position || '-' }}</CTableDataCell>
                  <CTableDataCell class="fw-semibold text-primary">{{ t.new_dept || '-' }} / {{ t.new_position || '-' }}</CTableDataCell>
                  <CTableDataCell><CBadge color="info">{{ t.type_desc || '발령' }}</CBadge></CTableDataCell>
        ...
        <template v-else-if="document.doc_type_detail?.form_template_key === 'HR_REQUEST' || document.doc_type_detail?.form_template_key === 'CERT_REQUEST'">
          <CTable small bordered responsive class="mb-0">
            <CTableBody>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">신청 구분</CTableHeaderCell>
                <CTableDataCell class="pl-3">
                  <CBadge color="primary">{{ docContent.request_type || '제증명서 발급' }}</CBadge>
                </CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">수령 방법</CTableHeaderCell>
                <CTableDataCell class="pl-3">{{ docContent.receive_method || 'PDF 이메일 수신' }}</CTableDataCell>
              </CTableRow>

              <!-- 증명서 전용 행 -->
              <template v-if="docContent.request_type === 'CERTIFICATE' || !docContent.request_type">
                <CTableRow>
                  ...
                  <CTableDataCell class="pl-3 fw-semibold text-primary">
                    {{ docContent.cert_type || '재직증명서' }} ({{ docContent.cert_language === 'ENGLISH' ? '영문' : '국문' }}, {{ docContent.cert_count ?? 1 }}부)
                  </CTableDataCell>
              ...
              <template v-else-if="docContent.request_type === 'CONGRATULATION_CONDOLENCE'">
                <CTableRow>
                  ...
                  <CTableDataCell class="pl-3 fw-semibold text-danger">{{ docContent.event_type || '-' }}</CTableDataCell>
                ...
                <CTableRow>
                  ...
                  <CTableDataCell class="pl-3 fw-bold text-danger">
                    {{ (Number(docContent.congratulation_amount ?? docContent.amount) || 0).toLocaleString() }} 원
                  </CTableDataCell>
                </CTableRow>
                <CTableRow v-if="docContent.support_items">
                  <CTableHeaderCell class="text-center bg-more-light">물품 지원 요청</CTableHeaderCell>
                  <CTableDataCell colspan="3" class="pl-3">{{ docContent.support_items }}</CTableDataCell>
                </CTableRow>
              </template>

              <!-- 휴복직 전용 행 -->
              <template v-else-if="docContent.request_type === 'LEAVE_OF_ABSENCE' || docContent.request_type === 'REINSTATEMENT'">
                <CTableRow>
                  ...
                  <CTableDataCell colspan="3" class="pl-3 fw-semibold">
                    <span v-if="docContent.request_type === 'LEAVE_OF_ABSENCE'">
                      휴직: {{ docContent.leave_start_date || '-' }} ~ {{ docContent.leave_end_date || '-' }}
                    </span>
                    <span v-else>
                      복직 희망일: {{ docContent.reinstatement_date || '-' }}
                    </span>
                  </CTableDataCell>
                </CTableRow>
              </template>
              ...
              <CTableRow>
                ...
                <CTableDataCell colspan="3" class="pl-3 py-3" style="white-space: pre-wrap; line-height: 1.6;">
                  {{ docContent.reason || '-' }}
                </CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.note">
        ...
        <template v-else-if="document.doc_type_detail?.form_template_key === 'EXPENSE_SETTLEMENT' || document.doc_type_detail?.form_template_key === 'SETTLEMENT'">
          <CTable small bordered responsive class="mb-3">
            <CTableBody>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">정산 구분</CTableHeaderCell>
                <CTableDataCell class="pl-3">
                  <CBadge color="primary">{{ docContent.settlement_type === 'PERSONAL_EXPENSE' ? '개인경비 실비환급' : docContent.settlement_type === 'BUSINESS_TRIP' ? '출장경비 정산' : docContent.settlement_type === 'ADVANCE_PAY' ? '가지급금 정산' : '법인카드 사용정산' }}</CBadge>
                </CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">귀속 연월</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-bold">{{ docContent.target_month || '-' }}</CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.card_number">
                <CTableHeaderCell class="text-center bg-more-light">법인카드 정보</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3">{{ docContent.card_number }}</CTableDataCell>
              </CTableRow>
              ...
              <CTableRow>
                ...
                <CTableDataCell colspan="3" class="pl-3">{{ docContent.reason || '-' }}</CTableDataCell>
              </CTableRow>
            </CTableBody>
          </CTable>
          ...
          <!-- 영수증 세부 내역 그리드 -->
          <div v-if="docContent.items?.length" class="mb-2">
            <div class="small fw-semibold mb-1 text-primary">영수증 / 세부 사용 내역 (총 {{ docContent.items.length }}건)</div>
            <CTable small bordered responsive class="mb-0 text-center align-middle">
              ...
              <CTableBody class="small">
                <CTableRow v-for="(item, idx) in docContent.items" :key="idx">
                  <CTableDataCell>{{ item.date }}</CTableDataCell>
                  <CTableDataCell><CBadge color="secondary">{{ item.category }}</CBadge></CTableDataCell>
                  <CTableDataCell class="text-start fw-semibold">{{ item.merchant }}</CTableDataCell>
                  <CTableDataCell class="text-end fw-bold text-dark">{{ (Number(item.amount) || 0).toLocaleString() }}</CTableDataCell>
          ...
          <div class="d-flex justify-content-end align-items-center p-2 bg-light border rounded mb-2">
            ...
            <span class="fs-5 fw-bold text-danger">{{ (Number(docContent.total_amount ?? docContent.amount) || 0).toLocaleString() }} 원</span>
          </div>
        ...
        <template v-else-if="document.doc_type_detail?.form_template_key === 'ADVANCE' || document.doc_type_detail?.form_template_key === 'ADVANCE_PAY' || document.doc_type_detail?.form_template_key === 'ADVANCE_REQUEST'">
          <CTable small bordered responsive class="mb-3">
            <CTableBody>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">신청 구분</CTableHeaderCell>
                <CTableDataCell class="pl-3">
                  <CBadge color="danger">
                    {{ docContent.advance_type === 'PREPAYMENT' ? '선급금 (계약상 대금 선지급)' : docContent.advance_type === 'IMPREST_FUND' ? '전도금 (상비 운영비)' : docContent.advance_type === 'EVENT_FUND' ? '행사/프로젝트 진행비' : '가지급금 (업무용 선지급)' }}
                  </CBadge>
                </CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">지급 요청일</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-bold">{{ docContent.payment_due_date || '-' }}</CTableDataCell>
              </CTableRow>
              <CTableRow>
                ...
                <CTableDataCell class="pl-3 fw-bold text-danger fs-6">
                  {{ (Number(docContent.advance_amount ?? docContent.amount) || 0).toLocaleString() }} 원
                </CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light">정산 예정일</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-semibold text-primary">{{ docContent.settlement_due_date || '-' }}</CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.bank_name || docContent.account_number">
                <CTableHeaderCell class="text-center bg-more-light">입금(수령) 계좌</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3">
                  <span class="badge bg-light text-dark me-2">{{ docContent.receiver_type === 'VENDOR' ? '거래처 지급' : '임직원 계좌' }}</span>
                  {{ docContent.bank_name }} {{ docContent.account_number }} (예금주: {{ docContent.account_holder || '-' }})
                </CTableDataCell>
              </CTableRow>
              <CTableRow>
                ...
                <CTableDataCell colspan="3" class="pl-3" style="white-space: pre-wrap">
                  {{ docContent.purpose || docContent.reason || docContent.content || docContent.body || '-' }}
                </CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.settlement_promise !== false">
                ...
                <CTableDataCell colspan="3" class="pl-3 text-success fw-semibold">
                  ...
                  상기 선급금/가지급금을 수령한 후, 정산 예정일까지 적격 증빙을 첨부하여 전액 정산할 것을 확약함
                </CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.note">
                <CTableHeaderCell class="text-center bg-more-light">비고 / 특이사항</CTableHeaderCell>
        ...
        <template v-else-if="document.doc_type_detail?.form_template_key === 'CONTRACT' || document.doc_type_detail?.form_template_key === 'CONTRACT_APPROVAL' || document.doc_type_detail?.form_template_key === 'CONTRACT_PROPOSAL'">
          <CTable small bordered responsive class="mb-3">
            <CTableBody>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">계약 구분</CTableHeaderCell>
                <CTableDataCell class="pl-3">
                  <CBadge color="info" class="me-1">
                    {{ docContent.contract_type === 'CONSTRUCTION' ? '공사 도급/하도급' : docContent.contract_type === 'SERVICE' ? '용역/설계/감리/PM' : docContent.contract_type === 'PURCHASE' ? '물품공급/자재구매' : docContent.contract_type === 'LEASE' ? '부동산 임대차' : docContent.contract_type === 'MOU_NDA' ? 'MOU/NDA' : '일반 계약' }}
                  </CBadge>
                  <CBadge color="secondary">{{ docContent.contract_kind === 'CHANGE' ? '변경 계약' : docContent.contract_kind === 'RENEWAL' ? '갱신 계약' : '신규 계약' }}</CBadge>
                </CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">계약 건명</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-bold text-dark">{{ docContent.contract_name || '-' }}</CTableDataCell>
              </CTableRow>
              <CTableRow>
                ...
                <CTableDataCell colspan="3" class="pl-3">
                  ...
                  <span v-if="docContent.contractor_ceo" class="text-muted ms-2">(대표: {{ docContent.contractor_ceo }})</span>
                  <span v-if="docContent.contractor_reg_number" class="text-muted ms-2">| 사업자: {{ docContent.contractor_reg_number }}</span>
                  <span v-if="docContent.contractor_contact" class="text-muted ms-2">| 연락처: {{ docContent.contractor_contact }}</span>
                </CTableDataCell>
              </CTableRow>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">계약 금액</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-bold text-danger fs-6">
                  {{ (Number(docContent.contract_amount ?? docContent.amount) || 0).toLocaleString() }} 원
                  <span class="small fw-normal text-muted ms-1">({{ docContent.vat_type === 'INCLUDED' ? 'VAT 포함' : docContent.vat_type === 'ZERO_TAX' ? '면세' : 'VAT 별도' }})</span>
                </CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light">계약 기간</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-semibold text-primary">
                  {{ docContent.contract_start_date || '-' }} ~ {{ docContent.contract_end_date || '-' }}
                </CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.payment_terms">
                <CTableHeaderCell class="text-center bg-more-light">대금 지급 조건</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3">{{ docContent.payment_terms }}</CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.warranty_terms">
                <CTableHeaderCell class="text-center bg-more-light">이행 / 하자보증</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3">{{ docContent.warranty_terms }}</CTableDataCell>
              </CTableRow>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">체결 사유 / 배경</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3" style="white-space: pre-wrap">
                  {{ docContent.purpose_reason || docContent.purpose || docContent.reason || docContent.content || docContent.body || '-' }}
                </CTableDataCell>
              </CTableRow>
        ...
        <template v-else-if="document.doc_type_detail?.form_template_key === 'CONTRACT_CHANGE' || document.doc_type_detail?.form_template_key === 'CONTRACT_TERMINATION' || document.doc_type_detail?.form_template_key === 'CONTRACT_AMENDMENT'">
          <CTable small bordered responsive class="mb-3">
            <CTableBody>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">변경/해지 구분</CTableHeaderCell>
                <CTableDataCell class="pl-3">
                  <CBadge :color="docContent.change_type === 'TERMINATION' ? 'danger' : 'warning'">
                    {{ docContent.change_type === 'TERMINATION' ? '계약 해지 / 합의 해제' : docContent.change_type === 'AMOUNT_CHANGE' ? '금액 변경(증감)' : docContent.change_type === 'PERIOD_CHANGE' ? '기간 변경(연장)' : docContent.change_type === 'SCOPE_CHANGE' ? '과업/조건 변경' : '복합 변경 (금액+기간)' }}
                  </CBadge>
                </CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">계약 상대방</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-bold">{{ docContent.contractor_name || '-' }}</CTableDataCell>
              </CTableRow>
              <CTableRow>
                ...
                <CTableDataCell colspan="3" class="pl-3">
                  ...
                  <span v-if="docContent.original_contract_no" class="text-muted ms-2">(계약번호: {{ docContent.original_contract_no }})</span>
                  <span v-if="docContent.original_contract_date" class="text-muted ms-2">| 체결일: {{ docContent.original_contract_date }}</span>
                </CTableDataCell>
              </CTableRow>
              <!-- 변경 비교 (비 해지 시) -->
              <template v-if="docContent.change_type !== 'TERMINATION'">
                <CTableRow>
                  ...
                  <CTableDataCell class="pl-3">{{ (Number(docContent.original_amount) || 0).toLocaleString() }} 원</CTableDataCell>
                  <CTableHeaderCell class="text-center bg-more-light">증감 금액</CTableHeaderCell>
                  <CTableDataCell class="pl-3 fw-bold" :class="(Number(docContent.change_amount) || 0) >= 0 ? 'text-danger' : 'text-primary'">
                    {{ (Number(docContent.change_amount) || 0) >= 0 ? '+' : '' }}{{ (Number(docContent.change_amount) || 0).toLocaleString() }} 원
                  </CTableDataCell>
                </CTableRow>
                <CTableRow>
                  <CTableHeaderCell class="text-center bg-more-light">최종 변경 금액</CTableHeaderCell>
                  <CTableDataCell class="pl-3 fw-bold text-danger fs-6">
                    {{ (Number(docContent.final_amount ?? (Number(docContent.original_amount || 0) + Number(docContent.change_amount || 0))) || 0).toLocaleString() }} 원
                  </CTableDataCell>
                  <CTableHeaderCell class="text-center bg-more-light">변경 후 종료일</CTableHeaderCell>
                  <CTableDataCell class="pl-3 fw-semibold text-primary">
                    {{ docContent.final_end_date || '-' }}
                    <span v-if="docContent.period_change_desc" class="small text-muted ms-1">({{ docContent.period_change_desc }})</span>
                  </CTableDataCell>
                </CTableRow>
              </template>
              <!-- 해지 시 -->
              <template v-else>
                <CTableRow>
                  ...
                  <CTableDataCell class="pl-3 fw-bold text-danger">{{ docContent.termination_date || '-' }}</CTableDataCell>
                  <CTableHeaderCell class="text-center bg-more-light">타절 정산금액</CTableHeaderCell>
                  <CTableDataCell class="pl-3 fw-bold text-danger fs-6">{{ (Number(docContent.settlement_amount) || 0).toLocaleString() }} 원</CTableDataCell>
                </CTableRow>
                <CTableRow v-if="docContent.penalty_terms">
                  <CTableHeaderCell class="text-center bg-more-light">위약 / 보증몰취</CTableHeaderCell>
                  <CTableDataCell colspan="3" class="pl-3 text-danger">{{ docContent.penalty_terms }}</CTableDataCell>
                </CTableRow>
              </template>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">변경 / 해지 사유</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3" style="white-space: pre-wrap">
                  {{ docContent.change_reason || docContent.purpose || docContent.reason || docContent.content || docContent.body || '-' }}
                </CTableDataCell>
              </CTableRow>
        ...
        <template v-else-if="document.doc_type_detail?.form_template_key === 'LEGAL_REVIEW' || document.doc_type_detail?.form_template_key === 'LEGAL_CONSULTATION' || document.doc_type_detail?.form_template_key === 'LEGAL_ADVICE'">
          <CTable small bordered responsive class="mb-3">
            <CTableBody>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">검토 분야</CTableHeaderCell>
                <CTableDataCell class="pl-3">
                  <CBadge color="primary" class="me-1">
                    {{ docContent.review_type === 'CONTRACT_REVIEW' ? '계약서/협약서 검토' : docContent.review_type === 'LITIGATION_DISPUTE' ? '소송/분쟁 대응' : docContent.review_type === 'REGULATORY_COMPLIANCE' ? '법령해석/인허가' : docContent.review_type === 'INTERNAL_RULE' ? '사규/내부규정' : docContent.review_type === 'CLAIM_NOTICE' ? '내용증명/공문' : '법률 자문' }}
                  </CBadge>
                  <CBadge :color="docContent.urgency === 'VERY_URGENT' ? 'danger' : docContent.urgency === 'URGENT' ? 'warning' : 'secondary'">
                    {{ docContent.urgency === 'VERY_URGENT' ? '당일 긴급' : docContent.urgency === 'URGENT' ? '긴급(1~2일)' : '보통' }}
                  </CBadge>
                </CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">회신 희망일</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-bold">{{ docContent.review_due_date || '-' }}</CTableDataCell>
              </CTableRow>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">의뢰 건명</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3 fw-bold text-dark">{{ docContent.case_title || '-' }}</CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.counterparty || docContent.dispute_amount">
                ...
                <CTableDataCell colspan="3" class="pl-3">
                  <span v-if="docContent.counterparty" class="fw-semibold me-3">상대방: {{ docContent.counterparty }}</span>
                  <span v-if="docContent.dispute_amount" class="text-danger fw-bold">관련 가액: {{ (Number(docContent.dispute_amount) || 0).toLocaleString() }} 원</span>
                </CTableDataCell>
              </CTableRow>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">사실관계 및 배경</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3" style="white-space: pre-wrap">
                  {{ docContent.background || docContent.purpose || docContent.reason || docContent.content || docContent.body || '-' }}
                </CTableDataCell>
              </CTableRow>
              <CTableRow>
              ...
              <CTableRow v-if="docContent.legal_opinion || docContent.risk_level">
                ...
                <CTableDataCell colspan="3" class="pl-3 bg-light">
                  <div class="mb-2">
                    ...
                    <CBadge :color="docContent.risk_level === 'HIGH' ? 'danger' : docContent.risk_level === 'MEDIUM' ? 'warning' : 'success'">
                      {{ docContent.risk_level === 'HIGH' ? '높음 (중대 불리조항)' : docContent.risk_level === 'MEDIUM' ? '중간 (수정 권고)' : '낮음 (체결 가능)' }}
                    </CBadge>
                  </div>
                  <div style="white-space: pre-wrap" class="fw-semibold text-dark">
              ...
              <CTableRow v-if="docContent.enclosed_docs || docContent.note">
                ...
                <CTableDataCell colspan="3" class="pl-3 text-muted">{{ docContent.enclosed_docs || docContent.note }}</CTableDataCell>
              </CTableRow>
            </CTableBody>
          </CTable>
        </template>
        ...
        <template v-else-if="document.doc_type_detail?.form_template_key === 'BUSINESS_REVIEW' || document.doc_type_detail?.form_template_key === 'PROJECT_FEASIBILITY' || document.doc_type_detail?.form_template_key === 'BIZ_FEASIBILITY' || document.doc_type_detail?.form_template_key === 'PROJECT_REVIEW' || document.doc_type_detail?.form_template_key === 'INVESTMENT_REVIEW'">
          <CTable small bordered responsive class="mb-3">
            <CTableBody>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">사업명 (프로젝트)</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-bold text-dark fs-6">{{ docContent.project_name || docContent.case_title || '-' }}</CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">사업 유형</CTableHeaderCell>
                <CTableDataCell class="pl-3">
                  <CBadge color="info">
                    {{ docContent.biz_type === 'DEV_SELF' ? '자체 개발사업' : docContent.biz_type === 'DEV_TRUST' ? '토지신탁' : docContent.biz_type === 'CONTRACT_CIVIL' ? '단순 도급(시공)' : docContent.biz_type === 'REDEVELOPMENT' ? '재개발/재건축' : docContent.biz_type === 'PF_INVEST' ? '지분투자/공동개발' : '신규 사업' }}
                  </CBadge>
                </CTableDataCell>
              </CTableRow>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">사업 부지 위치</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3">{{ docContent.location || '-' }}</CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.building_scale || docContent.land_area || docContent.gross_floor_area">
                <CTableHeaderCell class="text-center bg-more-light">사업 규모 / 면적</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3">
                  <span v-if="docContent.building_scale" class="me-3 fw-semibold">{{ docContent.building_scale }}</span>
                  <span v-if="docContent.land_area" class="me-3 text-muted">대지: {{ docContent.land_area }} ㎡</span>
                  <span v-if="docContent.gross_floor_area" class="text-muted">연면적: {{ docContent.gross_floor_area }} ㎡</span>
                </CTableDataCell>
              </CTableRow>
              <!-- 수지 분석 요약 -->
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">총 분양/매출 수입</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-bold text-primary">{{ (Number(docContent.total_revenue) || 0).toLocaleString() }} 원</CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light">총 사업비(지출)</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-bold text-danger">{{ (Number(docContent.total_cost) || 0).toLocaleString() }} 원</CTableDataCell>
              </CTableRow>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">예상 세전 이익</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-bold fs-6" :class="(Number(docContent.net_profit ?? ((Number(docContent.total_revenue || 0) - Number(docContent.total_cost || 0)))) || 0) >= 0 ? 'text-success' : 'text-danger'">
                  {{ (Number(docContent.net_profit ?? ((Number(docContent.total_revenue || 0) - Number(docContent.total_cost || 0)))) || 0).toLocaleString() }} 원
                </CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light">수익률 (ROI)</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-bold text-dark">{{ docContent.profit_rate ?? '-' }} %</CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.required_equity || docContent.pf_loan_amount">
                ...
                <CTableDataCell colspan="3" class="pl-3">
                  <span v-if="docContent.required_equity" class="me-3">자기자본(Equity): <strong>{{ (Number(docContent.required_equity) || 0).toLocaleString() }} 원</strong></span>
                  <span v-if="docContent.pf_loan_amount">PF 조달: <strong>{{ (Number(docContent.pf_loan_amount) || 0).toLocaleString() }} 원</strong></span>
                </CTableDataCell>
              </CTableRow>
              <!-- 사업 일정 -->
              <CTableRow v-if="docContent.land_secure_date || docContent.approval_target_date || docContent.start_date || docContent.completion_date">
                <CTableHeaderCell class="text-center bg-more-light">주요 추진 일정</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3 small">
                  <span v-if="docContent.land_secure_date" class="me-2">토지확보: {{ docContent.land_secure_date }} |</span>
                  <span v-if="docContent.approval_target_date" class="me-2">사업승인: {{ docContent.approval_target_date }} |</span>
                  <span v-if="docContent.start_date" class="me-2">착공/분양: {{ docContent.start_date }} |</span>
                  <span v-if="docContent.completion_date">준공: {{ docContent.completion_date }}</span>
                </CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.market_analysis">
                <CTableHeaderCell class="text-center bg-more-light">입지 및 분양성</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3" style="white-space: pre-wrap">{{ docContent.market_analysis }}</CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.risk_factors">
                <CTableHeaderCell class="text-center bg-more-light">리스크 및 대책</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3" style="white-space: pre-wrap">{{ docContent.risk_factors }}</CTableDataCell>
              </CTableRow>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">종합 검토의견</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3" style="white-space: pre-wrap">
                  {{ docContent.recommendation || docContent.purpose || docContent.reason || docContent.content || docContent.body || '-' }}
                </CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.enclosed_docs || docContent.note">
        ...
        <template v-else-if="document.doc_type_detail?.form_template_key === 'BUSINESS_APPROVAL' || document.doc_type_detail?.form_template_key === 'PROJECT_APPROVAL' || document.doc_type_detail?.form_template_key === 'DEV_APPROVAL' || document.doc_type_detail?.form_template_key === 'INVESTMENT_APPROVAL'">
          <CTable small bordered responsive class="mb-3">
            <CTableBody>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">사업명 (프로젝트)</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-bold text-dark fs-6">{{ docContent.project_name || docContent.case_title || '-' }}</CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">승인 의결 구분</CTableHeaderCell>
                <CTableDataCell class="pl-3">
                  <CBadge color="success">
                    {{ docContent.approval_type === 'NEW_LAUNCH' ? '사업 공식 론칭' : docContent.approval_type === 'LAND_ACQUISITION' ? '토지 매매/계약금 집행' : docContent.approval_type === 'SPC_ESTABLISH' ? 'SPC/PFV 설립' : docContent.approval_type === 'PF_EXECUTION' ? '본 PF 약정/인출' : docContent.approval_type === 'CONSTRUCTION_START' ? '시공 도급/착공' : '주요 사업 승인' }}
                  </CBadge>
                </CTableDataCell>
              </CTableRow>
              <CTableRow>
                ...
                <CTableDataCell class="pl-3">{{ docContent.biz_scale_summary || '-' }}</CTableDataCell>
              </CTableRow>
              <!-- 금회 승인 요청 예산 및 전체 사업비 -->
              <CTableRow class="bg-success bg-opacity-10">
                <CTableHeaderCell class="text-center text-success fw-bold">금회 승인 요청액</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-bold text-success fs-5">
                  {{ (Number(docContent.requested_amount ?? docContent.approval_budget ?? docContent.amount) || 0).toLocaleString() }} 원
                </CTableDataCell>
              ...
              <CTableRow v-if="docContent.total_expected_revenue || docContent.expected_profit">
                ...
                <CTableDataCell class="pl-3 fw-semibold text-primary">{{ (Number(docContent.total_expected_revenue) || 0).toLocaleString() }} 원</CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light">예상 세전 이익</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-semibold" :class="(Number(docContent.expected_profit ?? ((Number(docContent.total_expected_revenue || 0) - Number(docContent.total_project_cost || 0)))) || 0) >= 0 ? 'text-primary' : 'text-danger'">
                  {{ (Number(docContent.expected_profit ?? ((Number(docContent.total_expected_revenue || 0) - Number(docContent.total_project_cost || 0)))) || 0).toLocaleString() }} 원
                </CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.budget_usage_plan">
                <CTableHeaderCell class="text-center bg-more-light">예산 집행 내역</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3 fw-semibold text-dark">{{ docContent.budget_usage_plan }}</CTableDataCell>
              </CTableRow>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">승인 의결 사항</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3" style="white-space: pre-wrap">
                  {{ docContent.resolution_matters || docContent.purpose || docContent.reason || docContent.content || docContent.body || '-' }}
                </CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.pm_lead || docContent.target_schedule">
                ...
                <CTableDataCell colspan="3" class="pl-3">
                  <span v-if="docContent.pm_lead" class="me-3 fw-semibold">PM/부서: {{ docContent.pm_lead }}</span>
                  <span v-if="docContent.target_schedule" class="text-muted">추진일정: {{ docContent.target_schedule }}</span>
                </CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.expected_effects || docContent.risk_mitigation">
                ...
                <CTableDataCell colspan="3" class="pl-3" style="white-space: pre-wrap">{{ docContent.expected_effects || docContent.risk_mitigation }}</CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.enclosed_docs || docContent.note">
                <CTableHeaderCell class="text-center bg-more-light">첨부 서류 / 비고</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3 text-muted">{{ docContent.enclosed_docs || docContent.note }}</CTableDataCell>
        ...
        <template v-else-if="document.doc_type_detail?.form_template_key === 'PROJECT_DECISION' || document.doc_type_detail?.form_template_key === 'PROJECT_KEY_DECISION' || document.doc_type_detail?.form_template_key === 'DECISION_PROPOSAL' || document.doc_type_detail?.form_template_key === 'KEY_DECISION'">
          <CTable small bordered responsive class="mb-3">
            <CTableBody>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">현안 분야</CTableHeaderCell>
                <CTableDataCell class="pl-3">
                  <CBadge color="danger" class="me-1">
                    {{ docContent.decision_type === 'DESIGN_SPEC' ? '설계변경/스펙' : docContent.decision_type === 'SALES_PRICING' ? '분양가/분양조건' : docContent.decision_type === 'CONSTRUCTION_METHOD' ? '시공공법/자재' : docContent.decision_type === 'FINANCIAL_STRUCTURING' ? '금융구조/PF' : docContent.decision_type === 'CLAIM_DISPUTE' ? '민원/분쟁대응' : docContent.decision_type === 'CONTRACTOR_TERMINATION' ? '업체선정/타절' : '프로젝트 의사결정' }}
                  </CBadge>
                  <CBadge :color="docContent.urgency === 'CRITICAL' ? 'danger' : docContent.urgency === 'URGENT' ? 'warning' : 'secondary'">
                    {{ docContent.urgency === 'CRITICAL' ? '즉시 결정' : docContent.urgency === 'URGENT' ? '긴급' : '보통' }}
                  </CBadge>
                </CTableDataCell>
                <CTableHeaderCell class="text-center bg-more-light" style="width: 130px">결정 목표일</CTableHeaderCell>
                <CTableDataCell class="pl-3 fw-bold">{{ docContent.decision_due_date || '-' }}</CTableDataCell>
              </CTableRow>
              <CTableRow>
                <CTableHeaderCell class="text-center bg-more-light">심의 안건명</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3 fw-bold text-dark fs-6">{{ docContent.decision_subject || docContent.case_title || '-' }}</CTableDataCell>
              </CTableRow>
              ...
              <CTableRow>
                ...
                <CTableDataCell colspan="3" class="pl-3" style="white-space: pre-wrap">
                  {{ docContent.background_issue || docContent.purpose || docContent.reason || docContent.content || docContent.body || '-' }}
                </CTableDataCell>
              </CTableRow>
              <!-- 대안 비교 -->
              <CTableRow v-if="docContent.option_1">
                <CTableHeaderCell class="text-center bg-secondary bg-opacity-10 text-secondary">대안 1 (원안)</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3" style="white-space: pre-wrap">{{ docContent.option_1 }}</CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.option_2">
                <CTableHeaderCell class="text-center bg-primary bg-opacity-10 text-primary fw-bold">대안 2 (추천안)</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3 bg-light fw-semibold text-dark" style="white-space: pre-wrap">{{ docContent.option_2 }}</CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.option_3">
                <CTableHeaderCell class="text-center bg-more-light">대안 3 (기타안)</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3" style="white-space: pre-wrap">{{ docContent.option_3 }}</CTableDataCell>
              </CTableRow>
              <!-- 추천안 -->
              <CTableRow class="bg-warning bg-opacity-10">
                <CTableHeaderCell class="text-center fw-bold text-dark">주관부서 추천안</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3 fw-bold text-dark" style="white-space: pre-wrap">
              ...
              <CTableRow v-if="docContent.action_plan">
                ...
                <CTableDataCell colspan="3" class="pl-3">{{ docContent.action_plan }}</CTableDataCell>
              </CTableRow>
              <CTableRow v-if="docContent.enclosed_docs || docContent.note">
                <CTableHeaderCell class="text-center bg-more-light">첨부 서류 / 비고</CTableHeaderCell>
                <CTableDataCell colspan="3" class="pl-3 text-muted">{{ docContent.enclosed_docs || docContent.note }}</CTableDataCell>
