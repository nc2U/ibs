...
const props = defineProps({
  infoFiles: { type: Array as PropType<ContractFile[]>, default: () => [] },
...
<template>
  <CRow class="my-3 py-2" :class="{ 'bg-light': !isDark }">
    <CFormLabel class="col-sm-2 col-form-label">등기부 등본</CFormLabel>
    <CCol sm="10">
      <template v-if="!!infoFiles.length">
        <CRow v-for="file in infoFiles" :key="file.pk" class="mb-2" style="padding-top: 6px">
          <CCol sm="10">
